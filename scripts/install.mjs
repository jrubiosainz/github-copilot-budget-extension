...
const extensionName = "squad-budget";
...
try {
  ...
  console.log(`✓ squad-budget extension ${action} successfully!`);
  console.log(`  Location: ${extensionsDir}`);
  console.log(`\nRestart the GitHub Copilot CLI session to activate the extension.`);
  console.log(`The dashboard will appear at http://127.0.0.1:51953/ when running in a Squad workspace.`);
} catch (error) {
